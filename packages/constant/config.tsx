export const meta = {
  ...
  author: "Brice Suazo",
  description:
    "I'm a full-stack developer based in Philippines. I have a passion for building web applications and solving problems",
  //url: process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : `http://localhost:${process.env.PORT || 3000}`,
  url: "https://bricesuazo.com",
  locale: "en_US",
  siteName: "Brice Suazo",
  accounts: {
    github: {
      username: "bricesuazo",
      repo: "bricesuazo.com",
...
export const contact = {
  links: [
    {
      href: "mailto:contact@bricesuazo.com",
      title: "Email",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-5 w-5 duration-200 motion-reduce:transition-none"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
    ...
    },
    {
      ...
      icon: (
        <svg
          className="h-5 w-5 fill-[#5865F2] duration-200 motion-reduce:transition-none"
          width="71"
          height="55"
          viewBox="0 0 71 55"
          fill="none"
    ...
    },
    {
      ...
      icon: (
        <svg
          className="h-5 w-5 fill-black duration-200 motion-reduce:transition-none dark:fill-white"
          fill="currentColor"
          height="16"
          viewBox="0 0 22 20"
        >
