      ...
      <div>
        ...
        <div className="text-left">
          <Link
            key={repo.id}
            href={repo.url}
            className="break-all text-left font-semibold"
            target="_blank"
          >
            <FolderIcon className="inline h-5 w-5 fill-black/[10%] stroke-black/[70%] duration-200 motion-reduce:transition-none dark:fill-white/[10%] dark:stroke-white/[70%]" />{" "}
...
export function RepoCardSkeleton() {
  return (
    <div className="h-full rounded-[10px] border-[1px] border-black/[15%] bg-white p-5 duration-200 hover:shadow-xl motion-reduce:transition-none dark:border-neutral-800 dark:bg-[#161617]">
      <div className="aspect-[16/8] animate-pulse rounded-xl bg-gray-200/[15%]" />
      <div className="mt-5 h-6 w-2/4 animate-pulse rounded-md bg-gray-200/[15%]" />
      <div className="mt-3 h-6 animate-pulse rounded-md bg-gray-200/[15%]" />
